...
public partial class ModifyA : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string strQuery = "Select * from tblFiles2 order by ID";
    ...
    protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string strQuery = "update tblFiles2 set FileName=@FileName, FilePath=@FilePath where ID=@ID";
        SqlCommand cmd = new SqlCommand(strQuery);
        ...
        cmd.Parameters.AddWithValue("@FilePath", "../image1/" + fileName);
        cmd.CommandType = CommandType.Text;
        cmd.Connection = con;
        con.Open();
        cmd.ExecuteNonQuery();
        ...
        File.Delete(Server.MapPath("~/image1/") + oldFileName);
        file.SaveAs(Server.MapPath("~/image1/") + fileName);
        Gridview1.EditIndex = -1;
        //Response.Redirect(Request.Url.AbsoluteUri);

        Response.Redirect("ModifyA.aspx");
    }
