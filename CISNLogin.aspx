<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CISNLogin.aspx.cs" Inherits="CISNLogin" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
   
    <head>
        <title>CISN Portals login</title>
...
p.agreement label{
    ...
    <body> 
        ...
        <form id="FormApplicationReg" class="register" runat="server" method="post">
            ...
            <h1 align="center"><img src="Resc/cislogo22.jpg" /><br />CISN Portals Login</h1>
         <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../Default.aspx"><img src="../Resc/hmm.png" width="32" height="32" /></a></div>
           <%-- <br />
            <br />--%>
            ...
            <table align="center">
                ...
                <tr>
                     <td align="center">
                 <h3>  <a href="StudentLogin.aspx">Students Portal</a></h3>
                    </td>
                    </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                     <td align="center">
                 <h3>  <a href="StaffLogin.aspx">Staff Portal</a></h3>
                    </td>
                </tr>
                <tr>
                    <td></td>
                 ...
                 <tr>
                    <td align="center">
             <h3>      <a href="AdminLogin.aspx">Admin Portal</a></h3>
                    </td>
                 </tr>
...
<%--                <br />
                ...
                <p align="center">
                  ...
                  <b style="color:green"> CISN Portals Management Service 2018. All Rights reserved</b>
