...
public partial class ModifyAR : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string strQuery = "Select * from tblFiles4 order by ID";
    ...
    protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string strQuery = "update tblFiles4 set FileName=@FileName, FilePath=@FilePath where ID=@ID";
        SqlCommand cmd = new SqlCommand(strQuery);
        ...
        cmd.Parameters.AddWithValue("@FilePath", "../image3/" + fileName);
        cmd.CommandType = CommandType.Text;
        cmd.Connection = con;
        con.Open();
        cmd.ExecuteNonQuery();
        ...
        File.Delete(Server.MapPath("~/image3/") + oldFileName);
        file.SaveAs(Server.MapPath("~/image3/") + fileName);
        Gridview1.EditIndex = -1;
        //Response.Redirect(Request.Url.AbsoluteUri);

        Response.Redirect("ModifyAR.aspx");
    }
}