<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sam11.aspx.cs" Inherits="sam11" %>
...
<body>
    ...
    <section class="banner-bottom-w3layouts py-lg-5 py-lg-4 py-4">
        <div class="container">
            <div class="inner-sec-wthree-w3ls py-lg-4 py-4">
                <h3 class="tittle-w3l text-center mb-lg-5 mb-3">
                    <span>Visit</span>Explore Cources</h3>
                <div class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="cource-box-info text-center rounded">
                            <div class="card">
                                <div class="card-body">
                                    <img src="images/g3.jpg" alt="Collegien" class="img-fluid">
                ...
                <div class="row">
					...
					<div class="card">
						<div class="card-body">
							...
							<h5 class="card-title">Mega Library</h5>
                    ...
                    <div class="col-lg-4 service-in text-center">
                       ...
                       <div class="col-lg-4 service-in text-center">
						...
						<div class="card-body">
							...
							<h5 class="card-title">Learn Music</h5>
							<p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut labore.
							</p>
						</div>
					</div>
    ...
    <section class="banner-bottom-w3layouts bg-light py-md-5 py-4">
        <div class="container">
            <div class="inner-sec-wthree-w3ls py-md-5 py-4">
                <h3 class="tittle-w3l text-center mb-lg-5 mb-3">
                    <span>Visit</span>Upcoming Events </h3>
                <div class="row choose-main ">
                    <div class="col-lg-6 galsses-grid-right">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sedc dnmo eiusmod tempor incididunt ut consectetur
                            adipisicing elit sedc labore et dolore magna aliqua uta enim ad minim.. </p>
                        <div class="read inner mt-4">
						<a href="about.html" class="btn btn-sm animated-button victoria-two">Read More</a>
					</div>
     ...
     <!--//events-->
				...
				<div class="testimonials py-lg-5 py-4">
					<div class="testimonials-inner py-lg-4 py-3">
						<h3 class="tittle-w3l text-center my-lg-4 mt-3">Tesimonials</h3>
			...
			<div class="row footer-grids">
				<div class="col-lg-4 col-md-6 footer-grid text-left">
					<div class="footer-logo">
						<h3 class="mb-3"><a class="logo" href="index.html">Collegian</a></h3>
...
<div class="copy_right_w3ls py-4 text-center">
    <p>© 2018 Collegian. All rights reserved | Design by <a href="http://w3layouts.com/">W3layouts</a></p>
