...
public partial class ModifyC : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string strQuery = "Select * from tblFiles3 order by ID";
    ...
    protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string strQuery = "update tblFiles3 set FileName=@FileName, FilePath=@FilePath where ID=@ID";
        SqlCommand cmd = new SqlCommand(strQuery);
        ...
        cmd.Parameters.AddWithValue("@FilePath", "../image2/" + fileName);
        cmd.CommandType = CommandType.Text;
        cmd.Connection = con;
        con.Open();
        cmd.ExecuteNonQuery();
       ...
       // Response.Write(hold);
        ...
        File.Delete(Server.MapPath("~/image2/") + oldFileName);
        file.SaveAs(Server.MapPath("~/image2/") + fileName);
        Gridview1.EditIndex = -1;
        //Response.Redirect(Request.Url.AbsoluteUri);

        Response.Redirect("ModifyC.aspx");
    }
}