...
p.agreement label{
    ...
    <body> 
        ...
        <form id="FormApplicationReg" class="register" runat="server" method="post">
            ...
            <h1 align="center"><img src="Resc/cislogo22.jpg" /><br />CISN Student Login</h1>
         <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             
             <%--<a href="#">
             <img src="../Resc/bck.png" width="32" height="32" /></a>--%>
             
             &nbsp;&nbsp;<a href="../Default.aspx">
                 
                 <img src="../Resc/hmm.png" width="32" height="32" /></a></div>
            <br />
            <br />
    ...
    <tr>
                ...
                <tr>
                    <td>
                          <div><asp:Label runat="server" ID="LabelStudentLoginMssg" ForeColor="Blue"></asp:Label></div>
                    </td>
                </tr>
            </table>
