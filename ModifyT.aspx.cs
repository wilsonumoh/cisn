...
public partial class ModifyT : System.Web.UI.Page
{
    ...
    protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        cmd.Parameters.AddWithValue("@FilePath", "../imageT/" + fileName);
        cmd.CommandType = CommandType.Text;
        cmd.Connection = con;
        con.Open();
        cmd.ExecuteNonQuery();
        ...
        File.Delete(Server.MapPath("~/imageT/") + oldFileName);
        file.SaveAs(Server.MapPath("~/imageT/") + fileName);
        Gridview1.EditIndex = -1;
        //Response.Redirect(Request.Url.AbsoluteUri);

        Response.Redirect("ModifyT.aspx");
    }
}
